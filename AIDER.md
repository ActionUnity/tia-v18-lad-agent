...
real project, do not create a new TIA project; first use an unchanged
...
requires separate `-AllowCreate`. Keep final FB/FC logic in LAD. Never download,
go online, force variables, or edit safety/F objects.
